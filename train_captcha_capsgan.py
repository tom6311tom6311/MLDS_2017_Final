...
import CaptchaCapsuleGAN
import ElapsedTimer


if __name__ == '__main__':
	captcha_gan = CaptchaCapsuleGAN.CaptchaCapsuleGAN(image_shape=[60,60,3])
	timer = ElapsedTimer.ElapsedTimer()
        # batch_size = 256 causes OOM
	captcha_gan.train(train_steps=1000000, batch_size=128, save_interval=20)
	timer.elapsedTime()
